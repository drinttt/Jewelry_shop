    ...
    <head>
        ...
        <script>
            function send(){
                ...
                var url = "searchajaxnecklace.php?keyword="+keyword;
    ...
    <header class='header'>
        ...
        <nav>
            <ul class="navbar">
                ...
                <li><a class="navlinkhome" href="necklace.php">NECKLACE</a></li>|
        ...
        <div class="productall">
            <?php
                $stmt=$pdo->prepare("SELECT * FROM `product` WHERE id_type='T001'");
                $stmt->execute();
